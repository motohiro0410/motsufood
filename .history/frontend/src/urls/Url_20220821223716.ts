...
export const userEdit = (id: string) => `${DEFAULT_API_LOCALHOST}/users/${id}/edit`
export const userDestroy = (id: string) => `${DEFAULT_API_LOCALHOST}/users/${id}`
export const userCreate = `${DEFAULT_API_LOCALHOST}/users`
export const userUpdate = (id: string) => `${DEFAULT_API_LOCALHOST}/users/${id}`
