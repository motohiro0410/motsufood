...
import { Grid, Typography, Card, Stack, CardMedia, CardContent } from "@mui/material"
            ...
            <Grid item xs={3} sm={3}>
              <Card sx={{ height: 150 }}>
                <Stack textAlign="center">
                  <CardMedia component="image" height="100" src="/static/images/cards/contemplative-reptile.jpg" />
                  <CardContent>
                    <Typography>
                      user1
                    </Typography>
