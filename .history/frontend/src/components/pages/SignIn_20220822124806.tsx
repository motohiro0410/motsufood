...
export const SignIn = () => {
  ...
  // 取得データの送信
  const createFormData: FC<User> = () => {          //add
    const formData = new FormData()                   //labelがundefinedの場合早期リターン
    formData.append('user[name]', name) // ポイント1！
    formData.append('user[email]', email) // ポイント1！
    return formData
  }
